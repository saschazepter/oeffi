 ...
 * great code.
 */
package de.schildbach.oeffi.util.bzip2;
...
public class BZip2CompressorInputStream extends CompressorInputStream implements BZip2Constants {
     ...
     * This doesn't suppprt decompressing concatenated .bz2 files.
     * 
     * @throws IOException
     ...
     *            if true, decompress until the end of the input; if false, stop after the first .bz2 stream
     *            and leave the input position to point to the next byte after the .bz2 stream
     *
     * @throws IOException
     *             if the stream content is malformed or an I/O error occurs.
     * @throws NullPointerException
    ...
    private boolean init(boolean isFirstStream) throws IOException {
        ...
        if (magic0 != 'B' || magic1 != 'Z' || magic2 != 'h') {
            throw new IOException(
                    isFirstStream ? "Stream is not in the BZip2 format" : "Garbage after a valid BZip2 stream");
        }
    ...
    private void initBlock() throws IOException {
        ...
        while (true) {
            ...
            // End of stream was reached. Check the combined CRC and advance to the next .bz2 stream if
            // decoding concatenated streams.
            if (complete()) {
                return;
            }
        }
    ...
    private boolean complete() throws IOException {
        ...
        // Look for the next .bz2 stream if decompressing concatenated files.
    ...
    private static final class Data extends Object {
         ...
         * 
         * This method is called when the required length of the array is known. I don't initialize it at
         * construction time to avoid unneccessary memory allocation when compressing small files.
         */
        int[] initTT(int length) {
            int[] ttShadow = this.tt;

            // tt.length should always be >= length, but theoretically it can happen, if the compressor mixed
            // small and large blocks. Normally only the last block will be smaller than others.
